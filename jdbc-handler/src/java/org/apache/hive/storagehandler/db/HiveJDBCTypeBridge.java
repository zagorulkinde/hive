...
public interface HiveJDBCTypeBridge {
   ...
   *
   * @param sqlValue an Object returned from {@link java.sql.ResultSet#getObject}
   * @param sqlType  the Class object returned from {@link java.sql.ResultSetMetaData#getColumnClassName}
